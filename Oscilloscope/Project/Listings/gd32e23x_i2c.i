# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c" 2
# 53 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_deinit(uint32_t i2c_periph)
{
    switch(i2c_periph) {
...
# 83 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_clock_config(uint32_t i2c_periph, uint32_t clkspeed, uint32_t dutycyc)
{
    ...
    if(freq >= ((uint32_t)0x0000007FU)) {
        freq = ((uint32_t)0x0000007FU);
    }
    temp = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U));
    temp &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6))));
    temp |= freq;

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) = temp;

    if(100000U >= clkspeed) {

        risetime = (uint32_t)((pclk1 / 1000000U) + 1U);
        if(risetime >= ((uint32_t)0x0000007FU)) {
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = ((uint32_t)0x0000007FU);
        } else if(risetime <= ((uint32_t)0x00000002U)) {
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = ((uint32_t)0x00000002U);
        } else {
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = risetime;
        }
        ...
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & clkc);

    } else if(400000U >= clkspeed) {

        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = (uint32_t)(((freq * (uint32_t)300U) / (uint32_t)1000U) + (uint32_t)1U);
        if(((uint32_t)0x00000000U) == dutycyc) {

            clkc = (uint32_t)(pclk1 / (clkspeed * 3U));
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) &= ~((uint32_t)((uint32_t)0x01U<<(14)));
        } else {

            clkc = (uint32_t)(pclk1 / (clkspeed * 25U));
            (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) |= ((uint32_t)((uint32_t)0x01U<<(14)));
        }
        if(0U == (clkc & ((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))))) {

            clkc |= 0x0001U;
        }
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000001CU)) |= clkc;
    } else {

        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000020U)) = (uint32_t)(((freq * (uint32_t)120U) / (uint32_t)1000U) + (uint32_t)1U);
        if(((uint32_t)0x00000000U) == dutycyc) {
        ...
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000090U)) = ((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
# 171 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_mode_addr_config(uint32_t i2c_periph, uint32_t mode, uint32_t addformat, uint32_t addr)
{

    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(1))));
    ctl |= mode;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;

    addr = addr & ((uint32_t)0x000003FFU);
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000008U)) = (addformat | addr);
}
# 195 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_smbus_type_config(uint32_t i2c_periph, uint32_t type)
{
    if(((uint32_t)((uint32_t)0x01U<<(3))) == type) {
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(3)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(3))));
    }
}
# 214 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_ack_config(uint32_t i2c_periph, uint32_t ack)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(10))));
    ctl |= ack;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 234 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_ackpos_config(uint32_t i2c_periph, uint32_t pos)
{
    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(11))));
    ctl |= pos;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 255 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_master_addressing(uint32_t i2c_periph, uint32_t addr, uint32_t trandirection)
{

    if(((uint32_t)0xFFFFFFFEU) == trandirection) {
        addr = addr & ((uint32_t)0xFFFFFFFEU);
    } else {
        addr = addr | ((uint32_t)0x00000001U);
    }

    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) = addr;
}
# 274 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_dualaddr_enable(uint32_t i2c_periph, uint32_t addr)
{

    addr = addr & ((uint32_t)0x000000FEU);
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) = (((uint32_t)((uint32_t)0x01U<<(0))) | addr);
}
...
void i2c_dualaddr_disable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x0000000CU)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
}
...
void i2c_start_on_bus(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(8)));
}
...
void i2c_stop_on_bus(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(9)));
}
# 343 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_data_transmit(uint32_t i2c_periph, uint8_t data)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)) = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(data) << 0));
}
...
uint8_t i2c_data_receive(uint32_t i2c_periph)
{
    return (uint8_t)((((uint32_t)((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000010U)))) & ((0xFFFFFFFFUL << ((0))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((7)))))) >> (0));
}
# 369 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_dma_config(uint32_t i2c_periph, uint32_t dmastate)
{

    uint32_t ctl = 0U;

    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(11))));
    ctl |= dmastate;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) = ctl;
}
# 390 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_dma_last_transfer_config(uint32_t i2c_periph, uint32_t dmalast)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(12))));
    ctl |= dmalast;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U)) = ctl;
}
# 411 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_stretch_scl_low_config(uint32_t i2c_periph, uint32_t stretchpara)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(7))));
    ctl |= stretchpara;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 432 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_slave_response_to_gcall_config(uint32_t i2c_periph, uint32_t gcallpara)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(6))));
    ctl |= gcallpara;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 453 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_software_reset_config(uint32_t i2c_periph, uint32_t sreset)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(15))));
    ctl |= sreset;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 474 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_pec_config(uint32_t i2c_periph, uint32_t pecstate)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(5))));
    ctl |= pecstate;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 495 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_pec_transfer_config(uint32_t i2c_periph, uint32_t pecpara)
{
...
uint8_t i2c_pec_value_get(uint32_t i2c_periph)
{
    return (uint8_t)(((*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000018U)) & ((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15))))) >> ((uint32_t)0x00000008U));
}
# 527 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_smbus_alert_config(uint32_t i2c_periph, uint32_t smbuspara)
{
    ...
    ctl = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U));
    ctl &= ~(((uint32_t)((uint32_t)0x01U<<(13))));
    ctl |= smbuspara;
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000000U)) = ctl;
}
# 548 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_smbus_arp_config(uint32_t i2c_periph, uint32_t arpstate)
{
...
void i2c_sam_enable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000080U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void i2c_sam_timeout_enable(uint32_t i2c_periph)
{
    (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000080U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
# 636 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
FlagStatus i2c_flag_get(uint32_t i2c_periph, i2c_flag_enum flag)
{
    if(RESET != (((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x0000001FU)))))) {
        return SET;
    } else {
        return RESET;
    }
}
# 665 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_flag_clear(uint32_t i2c_periph, i2c_flag_enum flag)
{
    if(I2C_FLAG_ADDSEND == flag) {

        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000014U));
        (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000018U));
    } else {
        ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(flag) & 0x0000FFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x0000001FU))));
    }
}
# 691 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_interrupt_enable(uint32_t i2c_periph, i2c_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x0000001FU))));
}
# 711 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_interrupt_disable(uint32_t i2c_periph, i2c_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x0000001FU))));
}
# 742 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
FlagStatus i2c_interrupt_flag_get(uint32_t i2c_periph, i2c_interrupt_flag_enum int_flag)
{
    uint32_t intenable = 0U, flagstatus = 0U, bufie;


    bufie = (*(volatile uint32_t *)(uint32_t)((i2c_periph) + 0x00000004U))&((uint32_t)((uint32_t)0x01U<<(10)));


    intenable = (((*(volatile uint32_t *)(uint32_t)((i2c_periph) + (((uint32_t)(int_flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & 0x0000001FU)))));

    flagstatus = (((*(volatile uint32_t *)(uint32_t)((i2c_periph) + ((uint32_t)(int_flag) >> 22)))) & ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(int_flag) & 0x001F0000U) >> 16)))));
...
# 788 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_i2c.c"
void i2c_interrupt_flag_clear(uint32_t i2c_periph, i2c_interrupt_flag_enum int_flag)
{
    if(I2C_INT_FLAG_ADDSEND == int_flag) {
        ...
        ((*(volatile uint32_t *)(uint32_t)((i2c_periph) + ((uint32_t)(int_flag) >> 22)))) &= ~((uint32_t)((uint32_t)0x01U<<((((uint32_t)(int_flag) & 0x001F0000U) >> 16))));
    }
}
