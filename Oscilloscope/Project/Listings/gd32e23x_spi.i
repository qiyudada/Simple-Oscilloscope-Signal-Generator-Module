# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c" 2
# 57 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_deinit(uint32_t spi_periph)
{
    switch(spi_periph) {
    case ((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U):

        rcu_periph_reset_enable(RCU_SPI0RST);
        rcu_periph_reset_disable(RCU_SPI0RST);
        break;
    case (((uint32_t)0x40000000U) + 0x00003800U):
...
void spi_struct_para_init(spi_parameter_struct *spi_struct)
{
    ...
    spi_struct->device_mode = ((uint32_t)0x00000000U);
    spi_struct->trans_mode = ((uint32_t)0x00000000U);
    spi_struct->frame_size = (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(7) << 8));
    spi_struct->nss = ((uint32_t)0x00000000U);
    spi_struct->endian = ((uint32_t)0x00000000U);
    spi_struct->clock_polarity_phase = ((uint32_t)0x00000000U);
    spi_struct->prescale = (((0xFFFFFFFFUL << (3)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(5)))) & ((uint32_t)(0) << 3));
}
# 116 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
ErrStatus spi_init(uint32_t spi_periph, spi_parameter_struct *spi_struct)
{
    uint32_t reg1 = 0, reg2 = 0U, reg3 = 0U;

    reg1 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U));
    reg1 &= ((uint32_t)0x00003040U);

    reg2 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U));
    reg2 &= ((uint32_t)0x00003840U);

    reg3 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U));
    reg3 &= ((uint32_t)0x0000F0FFU);

    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
        ...
        if(((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(7) << 8)) != spi_struct->frame_size) && ((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(15) << 8)) != spi_struct->frame_size)) {
            return ERROR;
        } else {
            reg1 |= (spi_struct->frame_size & ((uint32_t)0x00000800U));
        }


        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) = (uint32_t)reg1;
        ...
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) = (uint32_t)reg2;


        reg3 |= spi_struct->frame_size;

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) = (uint32_t)reg3;
    }


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));
...
void spi_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(6)));
}
...
# 226 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t mode, uint32_t standard, uint32_t ckpl)
{
    uint32_t reg = 0U;
    reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU));
    reg &= ((uint32_t)0x0000F047U);


    reg |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) = (uint32_t)reg;
}
# 272 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_psc_config(uint32_t spi_periph, uint32_t audiosample, uint32_t frameformat, uint32_t mckout)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000020U)) = ((uint32_t)0x00000002U);


    i2sclock = rcu_clock_freq_get(CK_SYS);


    if(((uint32_t)((uint32_t)0x01U<<(9))) == mckout) {
        clks = (uint32_t)(((i2sclock / 256U) * 10U) / audiosample);
    } else {
        if((((0xFFFFFFFFUL << (1)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) & ((uint32_t)(0) << 1)) == frameformat) {
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000020U)) = (uint32_t)(i2sdiv | i2sof | mckout);


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) &= (uint32_t)(~(((0xFFFFFFFFUL << (1)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) | ((uint32_t)((uint32_t)0x01U<<(0)))));


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) |= (uint32_t)frameformat;
}
# 324 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void i2s_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000001CU)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(10)));
}
...
void spi_nss_output_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
}
...
void spi_nss_internal_high(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(8)));
}
...
# 394 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(1)));
    } else {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
# 413 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma) {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 432 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_transmit_odd_config(uint32_t spi_periph, uint16_t odd)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(14))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)odd;
}
# 450 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_receive_odd_config(uint32_t spi_periph, uint16_t odd)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(13))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)odd;
}
# 467 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
ErrStatus spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    uint32_t reg;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {

        if(((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(7) << 8)) != frame_format) && ((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(15) << 8)) != frame_format)) {
            return ERROR;
        } else {

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= ((uint32_t)frame_format & ((uint32_t)0x00000800U));
        }
    } else {
        reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U));

        reg &= (uint32_t)(~((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))));
        reg |= (uint32_t)frame_format;

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) = reg;
    }
    return SUCCESS;
}
# 501 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_fifo_access_size_config(uint32_t spi_periph, uint16_t fifo_access_size)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(12))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)fifo_access_size;
}
# 519 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
    if(((uint32_t)((uint32_t)0x01U<<(14))) == transfer_direction) {

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(14)));
    } else {

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) &= (~((uint32_t)((uint32_t)0x01U<<(14))));
    }
}
# 537 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
    uint32_t reg, byten;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000000CU)) = (uint32_t)data;
    } else {

        byten = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) & ((uint32_t)0x00001000U);
        if(RESET != byten) {
            reg = spi_periph + 0x0CU;
            *(uint8_t *)(reg) = (uint8_t)data;
        } else {
            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000000CU)) = (uint16_t)data;
        }
    }
}
...
uint16_t spi_i2s_data_receive(uint32_t spi_periph)
{
    uint32_t reg, byten;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph) {
        return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0000000CU)));
    } else {
...
# 586 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_format_error_clear(uint32_t spi_periph, uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) = (uint32_t)(~flag);
}
# 598 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph, uint16_t crc_poly)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(13)));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000010U)) = (uint32_t)crc_poly;
}
...
uint16_t spi_crc_polynomial_get(uint32_t spi_periph)
{
    return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000010U)));
}
# 627 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_crc_length_set(uint32_t spi_periph, uint16_t crc_length)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)crc_length;
}
...
void spi_crc_next(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000000U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
}
# 678 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph, uint8_t crc)
{
    if(((uint8_t)0x00U) == crc) {
        return ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000018U))));
    } else {
        return ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000014U))));
    }
}
...
void spi_crc_error_clear(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) = (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(4))));
}
...
void spi_ti_mode_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void spi_nssp_mode_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(3)));
}
...
void spi_quad_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000080U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void spi_quad_write_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000080U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
}
...
void spi_quad_io23_output_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000080U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
}
...
# 839 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) & flag)) {
        return SET;
    } else {
        if((((uint32_t)0x40000000U) + 0x00003800U) == spi_periph) {

            if((((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(12)))) & ((uint32_t)(0) << 11)) == flag) {
                if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) & ((uint32_t)0x00001800U))) {
                    return RESET;
                } else {
                    return SET;
                }
            ...
            if((((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)) == flag) {
                if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U)) & ((uint32_t)0x00000600U))) {
                    return RESET;
                } else {
                    return SET;
                }
...
# 878 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)interrupt;
}
# 895 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= ~(uint32_t)interrupt;
}
# 915 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
    uint32_t reg1 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000008U));
    uint32_t reg2 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U));

    switch(interrupt) {

    case ((uint8_t)0x00U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(1)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(7)));
        break;

    case ((uint8_t)0x01U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(0)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(6)));
        break;

    case ((uint8_t)0x02U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(6)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(5)));
        break;

    case ((uint8_t)0x03U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(5)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(5)));
        break;

    case ((uint8_t)0x04U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(4)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(5)));
        break;

    case ((uint8_t)0x05U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(3)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(5)));
        break;

    case ((uint8_t)0x06U):
        reg1 = reg1 & ((uint32_t)((uint32_t)0x01U<<(8)));
        reg2 = reg2 & ((uint32_t)((uint32_t)0x01U<<(5)));
        break;
    default :
        break;
