# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c" 2
...
# 61 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
void syscfg_dma_remap_enable(uint32_t syscfg_dma_remap)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= syscfg_dma_remap;
}
# 78 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
void syscfg_dma_remap_disable(uint32_t syscfg_dma_remap)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) &= ~syscfg_dma_remap;
}
...
void syscfg_high_current_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(19)));
}
...
# 115 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
void syscfg_exti_line_config(uint8_t exti_port, uint8_t exti_pin)
{
    uint32_t clear_exti_mask = ~((uint32_t)((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) << ((((uint8_t)(0x04U)) * ((exti_pin) % ((uint8_t)(0x04U))))));
    uint32_t config_exti_mask = ((uint32_t)exti_port) << ((((uint8_t)(0x04U)) * ((exti_pin) % ((uint8_t)(0x04U)))));

    switch(exti_pin / ((uint8_t)(0x04U))){
    case ((uint8_t)0x00U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) &= clear_exti_mask;

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x08U)) |= config_exti_mask;
        break;
    case ((uint8_t)0x01U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) &= clear_exti_mask;

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x0CU)) |= config_exti_mask;
        break;
    case ((uint8_t)0x02U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) &= clear_exti_mask;

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x10U)) |= config_exti_mask;
        break;
    case ((uint8_t)0x03U):

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) &= clear_exti_mask;

        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x14U)) |= config_exti_mask;
        break;
    default:
        break;
    }
}
# 159 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
void syscfg_lock_config(uint32_t syscfg_lock)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U)) |= syscfg_lock;
}
...
void irq_latency_set(uint8_t irq_latency)
{
    ...
    reg = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x100U)) &(~(uint32_t)((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))));
    reg |= (uint32_t)((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(irq_latency) << 0U)));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x100U)) = (uint32_t)reg;
}
...
FlagStatus syscfg_flag_get(uint32_t syscfg_flag)
{
    if(((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U)) & syscfg_flag) != (uint32_t)RESET){
        return SET;
    }else{
        return RESET;
    }
}
# 202 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_syscfg.c"
void syscfg_flag_clear(uint32_t syscfg_flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000000U) + 0x18U)) |= (uint32_t) syscfg_flag;
}
