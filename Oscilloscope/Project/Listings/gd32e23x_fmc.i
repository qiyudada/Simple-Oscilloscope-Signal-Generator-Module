# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c" 2
# 49 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_unlock(void)
{
    if((RESET != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) & ((uint32_t)((uint32_t)0x01U<<(7)))))){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x04U)) = ((uint32_t)0x45670123U);
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x04U)) = ((uint32_t)0xCDEF89ABU);
    }
}
# 65 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_lock(void)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(7)));
}
# 80 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_wscnt_set(uint8_t wscnt)
{
    uint32_t reg;

    reg = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U));

    reg &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U)) = (reg | wscnt);
}
...
void fmc_prefetch_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
}
...
# 125 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_page_erase(uint32_t page_address)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));

    if(FMC_READY == fmc_state){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x14U)) = page_address;
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(6)));


        fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
...
# 159 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_mass_erase(void)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
    ...
    if(FMC_READY == fmc_state){
        ...
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(2)));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(6)));
...
# 194 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_doubleword_program(uint32_t address, uint64_t data)
{
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
    if(FMC_READY == fmc_state){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
        (*(volatile uint32_t *)(uint32_t)(address)) = data0;
        (*(volatile uint32_t *)(uint32_t)(address+4U)) = data1;
...
# 237 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum fmc_word_program(uint32_t address, uint32_t data)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
...
# 264 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void ob_unlock(void)
{
    if(RESET == ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) & ((uint32_t)((uint32_t)0x01U<<(9))))){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x08U)) = ((uint32_t)0x45670123U);
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x08U)) = ((uint32_t)0xCDEF89ABU);
    }

    while(RESET == ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) & ((uint32_t)((uint32_t)0x01U<<(9))))){
    }
}
# 283 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void ob_lock(void)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) &= ~((uint32_t)((uint32_t)0x01U<<(9)));
}
...
void ob_reset(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(13)));
}
# 309 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
uint32_t option_byte_value_get(uint32_t addr)
{
    return *(volatile uint32_t *)(addr);
}
# 328 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum ob_erase(void)
{
    uint16_t fmc_spc;
    uint32_t val;
    ...
    if(((uint8_t)0x00U) == fmc_plevel){
        fmc_spc = ((uint16_t)0x5AA5U);
    }else if(((uint8_t)0x02U) == fmc_plevel){
        fmc_spc = ((uint16_t)0x44BBU);
    }else{
        fmc_spc = ((uint16_t)0x33CCU);
        fmc_state = FMC_OB_HSPC;
    }
    val = ((uint32_t)0xFFFF0000U) | (uint32_t)fmc_spc;

    if(FMC_READY == fmc_state){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(6)));
        ...
        if(FMC_READY == fmc_state){
            ...
            (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));


            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x1FFFF800U)) + 0x00U)) = val;
...
# 396 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum ob_write_protection_enable(uint16_t ob_wp)
{
    ...
    if(FMC_READY == fmc_state){
        ...
        if(0xFFFFFFFFU != ob_wrp_val){
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x1FFFF800U)) + 0x08U)) = ob_wrp_val;
...
# 441 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum ob_security_protection_config(uint16_t ob_spc)
{
    uint32_t val;
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));

    val = option_byte_value_get(((uint32_t)0x1FFFF800U));

    if(((uint8_t)0x06U) == ob_obstat_plevel_get()){
        fmc_state = FMC_OB_HSPC;
    }

    val &= ~((uint32_t)0x0000FFFFU);
    val |= (uint32_t)ob_spc;
...
# 513 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum ob_user_write(uint8_t ob_user)
{
    ...
    val_spc_user = option_byte_value_get(((uint32_t)0x1FFFF800U));

    val_spc_user &= ~((uint32_t)0xFFFF0000U);
    ...
    if(FMC_READY == fmc_state){
        ...
        if(FMC_READY == fmc_state){
            ...
            (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x1FFFF800U)) + 0x00U)) = val_spc_user;
...
# 574 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
fmc_state_enum ob_data_program(uint16_t data)
{
    fmc_state_enum fmc_state = fmc_ready_wait(((uint32_t)0x000F0000U));
    uint32_t val = 0U;
    ...
    if(FMC_READY == fmc_state){
        ...
        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x1FFFF800U)) + 0x04U)) = val;
...
uint8_t ob_user_get(void)
{
    return (uint8_t)((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x1CU)) >> ((uint32_t)8U));
}
...
uint16_t ob_data_get(void)
{
    return (uint16_t)((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x1CU)) >> ((uint32_t)16U));
}
...
uint16_t ob_write_protection_get(void)
{
    return (uint16_t)((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x20U)));
}
# 641 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
uint32_t ob_obstat_plevel_get(void)
{
    return ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x1CU)) & (((uint32_t)((uint32_t)0x01U<<(1))) | ((uint32_t)((uint32_t)0x01U<<(2)))));
}
# 655 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) |= interrupt;
}
# 668 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) &= ~(uint32_t)interrupt;
}
# 685 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
FlagStatus fmc_flag_get(uint32_t flag)
{
    FlagStatus status = RESET;

    if((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) & flag){
        status = SET;
    }

    return status;
}
# 707 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_flag_clear(uint32_t flag)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) = flag;
}
# 724 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
FlagStatus fmc_interrupt_flag_get(uint32_t int_flag)
{
    uint32_t intenable = 0U, flagstatus = 0U;

    if(((uint32_t)((uint32_t)0x01U<<(5))) == int_flag){

        intenable = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) & ((uint32_t)((uint32_t)0x01U<<(12)));

        flagstatus = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) & int_flag;
        ...
        intenable = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x10U)) & ((uint32_t)((uint32_t)0x01U<<(10)));
...
# 762 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fmc.c"
void fmc_interrupt_flag_clear(uint32_t int_flag)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) = int_flag;
}
...
fmc_state_enum fmc_state_get(void)
{
    ...
    if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) & ((uint32_t)((uint32_t)0x01U<<(0))))){
        fmc_state = FMC_BUSY;
    }else{
        if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) & ((uint32_t)((uint32_t)0x01U<<(4))))){
            fmc_state = FMC_WPERR;
        }else{
            if((uint32_t)0x00U != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x0CU)) & ((uint32_t)((uint32_t)0x01U<<(2))))){
                fmc_state = FMC_PGERR;
            }
        }
    }
