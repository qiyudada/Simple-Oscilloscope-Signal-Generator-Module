...
void systick_config(void)
{
    ...
    systick_clksource_set(((uint32_t)0xFFFFFFFBU));
...
void delay_1us(uint32_t count)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)(count * count_1us);

    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->VAL = 0x0000U;

    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = (1UL );

    do{
        ctl = ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL;
    }while((ctl&(1UL ))&&!(ctl & (1UL << 16U)));
...
void delay_1ms(uint32_t count)
{
    ...
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = (uint32_t)(count * count_1ms);
