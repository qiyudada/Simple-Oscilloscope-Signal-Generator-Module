# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c" 2
...
# 65 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_lvd_select(uint32_t lvdt_n)
{
...
# 87 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_ldo_output_select(uint32_t ldo_output)
{
...
# 114 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_to_sleepmode(uint8_t sleepmodecmd)
{
...
# 141 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_to_deepsleepmode(uint32_t ldo,uint8_t deepsleepmodecmd)
{
...
void pmu_to_standbymode(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)(0xE000E180U)) = 0XFFFFFFFBU;
    (*(volatile uint32_t *)(uint32_t)(0xE000E184U)) = 0XFFFFFFFFU;
    (*(volatile uint32_t *)(uint32_t)(0xE000E188U)) = 0xFFFFFFFFU;


    __builtin_arm_wfi();
}
# 206 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_wakeup_pin_enable(uint32_t wakeup_pin)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x04U)) |= wakeup_pin;
}
# 222 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_wakeup_pin_disable(uint32_t wakeup_pin)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x04U)) &= ~(wakeup_pin);
}
...
# 259 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
FlagStatus pmu_flag_get(uint32_t flag)
{
...
# 279 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_pmu.c"
void pmu_flag_clear(uint32_t flag)
{
    if(RESET != (flag & ((uint32_t)((uint32_t)0x01U<<(2))))){

        (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00007000U)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(2)));
    }
    if(RESET != (flag & ((uint32_t)((uint32_t)0x01U<<(3))))){
