# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c" 2
...
{
    switch(usart_periph){
    case ((((uint32_t)0x40000000U) + 0x00004400U) + 0x0000F400U):

        rcu_periph_reset_enable(RCU_USART0RST);
        rcu_periph_reset_disable(RCU_USART0RST);
        break;
    case (((uint32_t)0x40000000U) + 0x00004400U):
...
# 68 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_baudrate_set(uint32_t usart_periph, uint32_t baudval)
{
    ...
    if((*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) & ((uint32_t)((uint32_t)0x01U<<(15)))){

        udiv = ((2U*uclk)+baudval/2U)/baudval;
        intdiv = udiv & 0x0000fff0U;
        fradiv = (udiv>>1U) & 0x00000007U;
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x0000000CU)) = ((((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15))))) & (intdiv | fradiv));
    }else{
...
# 110 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_parity_config(uint32_t usart_periph, uint32_t paritycfg)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= paritycfg;
}
# 130 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_word_length_set(uint32_t usart_periph, uint32_t wlen)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(12)));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= wlen;
}
# 152 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_stop_bit_set(uint32_t usart_periph, uint32_t stblen)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= stblen;
}
...
# 193 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_transmit_config(uint32_t usart_periph, uint32_t txconfig)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(3)));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= txconfig;
}
# 210 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_receive_config(uint32_t usart_periph, uint32_t rxconfig)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(2)));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= rxconfig;
}
# 227 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_data_first_config(uint32_t usart_periph, uint32_t msbf)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(19))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= (((uint32_t)((uint32_t)0x01U<<(19))) & msbf);
}
# 251 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_invert_config(uint32_t usart_periph, usart_invert_enum invertpara)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    ...
    case USART_DINV_ENABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(18)));
        break;
    case USART_DINV_DISABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(18))));
        break;
    case USART_TXPIN_ENABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(17)));
        break;
    case USART_TXPIN_DISABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(17))));
        break;
    case USART_RXPIN_ENABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(16)));
        break;
    case USART_RXPIN_DISABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(16))));
        break;
    case USART_SWAP_ENABLE:
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
        break;
...
void usart_overrun_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((uint32_t)((uint32_t)0x01U<<(12))));
}
...
# 321 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_oversample_config(uint32_t usart_periph, uint32_t oversamp)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(15))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= oversamp;
}
# 340 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_sample_bit_config(uint32_t usart_periph, uint32_t osb)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((uint32_t)((uint32_t)0x01U<<(11))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= osb;
}
...
void usart_receiver_timeout_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(23)));
}
...
# 378 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_receiver_timeout_threshold_config(uint32_t usart_periph, uint32_t rtimeout)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000014U)) &= ~(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(23)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000014U)) |= rtimeout;
}
# 391 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_data_transmit(uint32_t usart_periph, uint32_t data)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000028U)) = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(8)))) & data);
}
...
uint16_t usart_data_receive(uint32_t usart_periph)
{
    return (uint16_t)(((((*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000024U))) & ((0xFFFFFFFFUL << ((0U))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((8U)))))) >> (0U)));
}
# 414 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_address_config(uint32_t usart_periph, uint8_t addr)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & (((uint32_t)addr) << 24));
}
# 433 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_address_detection_mode_config(uint32_t usart_periph, uint32_t addmod)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(4))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(4))) & (addmod);
}
...
void usart_mute_mode_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(13)));
}
...
# 474 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_mute_mode_wakeup_config(uint32_t usart_periph, uint32_t wmethod)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(11))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= wmethod;
}
...
void usart_lin_mode_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(14)));
}
...
# 521 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_lin_break_detection_length_config(uint32_t usart_periph, uint32_t lblen)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(5))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(5))) & (lblen);
}
...
void usart_halfduplex_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(3)));
}
...
void usart_clock_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= ((uint32_t)((uint32_t)0x01U<<(11)));
}
...
# 603 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_synchronous_clock_config(uint32_t usart_periph, uint32_t clen, uint32_t cph, uint32_t cpl)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) &= ~(((uint32_t)((uint32_t)0x01U<<(8))) | ((uint32_t)((uint32_t)0x01U<<(9))) | ((uint32_t)((uint32_t)0x01U<<(10))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= (((uint32_t)((uint32_t)0x01U<<(8))) & clen);
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= (((uint32_t)((uint32_t)0x01U<<(9))) & cph);
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000004U)) |= (((uint32_t)((uint32_t)0x01U<<(10))) & cpl);
}
# 622 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_guard_time_config(uint32_t usart_periph, uint32_t guat)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000010U)) &= ~(((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000010U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(15)))) & ((guat) << 8));
}
...
void usart_smartcard_mode_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(5)));
}
...
void usart_smartcard_mode_nack_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void usart_smartcard_mode_early_nack_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000D0U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
# 716 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_smartcard_autoretry_config(uint32_t usart_periph, uint32_t scrtnum)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= (((0xFFFFFFFFUL << (17)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(19)))) & (scrtnum << 17));
}
# 731 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_block_length_config(uint32_t usart_periph, uint32_t bl)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000014U)) &= ~(((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000014U)) |= (((0xFFFFFFFFUL << (24)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(31)))) & ((bl) << 24));
}
...
void usart_irda_mode_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
# 772 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_prescaler_config(uint32_t usart_periph, uint32_t psc)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000010U)) &= ~(((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000010U)) |= psc;
}
# 790 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_irda_lowpower_config(uint32_t usart_periph, uint32_t irlp)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((uint32_t)((uint32_t)0x01U<<(2))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= (((uint32_t)((uint32_t)0x01U<<(2))) & irlp);
}
# 808 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_hardware_flow_rts_config(uint32_t usart_periph, uint32_t rtsconfig)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((uint32_t)((uint32_t)0x01U<<(8))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= rtsconfig;
}
# 827 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_hardware_flow_cts_config(uint32_t usart_periph, uint32_t ctsconfig)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(9)));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ctsconfig;
}
# 846 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_hardware_flow_coherence_config(uint32_t usart_periph, uint32_t hcm)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000C0U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000C0U)) |= (((uint32_t)((uint32_t)0x01U<<(0))) & hcm);
}
...
void usart_rs485_driver_enable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(14)));
}
...
# 887 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_driver_assertime_config(uint32_t usart_periph, uint32_t deatime)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((0xFFFFFFFFUL << (21)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(25)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= (((0xFFFFFFFFUL << (21)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(25)))) & ((deatime) << 21));
}
# 903 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_driver_deassertime_config(uint32_t usart_periph, uint32_t dedtime)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(20)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= (((0xFFFFFFFFUL << (16)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(20)))) & ((dedtime) << 16));
}
# 922 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_depolarity_config(uint32_t usart_periph, uint32_t dep)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((uint32_t)((uint32_t)0x01U<<(15))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= (((uint32_t)((uint32_t)0x01U<<(15))) & dep);
}
# 941 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_dma_receive_config(uint32_t usart_periph, uint32_t dmacmd)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(6)));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= dmacmd;
}
# 958 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_dma_transmit_config(uint32_t usart_periph, uint32_t dmacmd)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~((uint32_t)((uint32_t)0x01U<<(7)));
...
void usart_reception_error_dma_disable(uint32_t usart_periph)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((uint32_t)((uint32_t)0x01U<<(13)));
}
...
void usart_wakeup_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
# 1026 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_wakeup_mode_config(uint32_t usart_periph, uint32_t wum)
{

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000000U)) &= ~(((uint32_t)((uint32_t)0x01U<<(0))));

    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) &= ~(((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))));
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000008U)) |= ((0xFFFFFFFFUL << (20)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & (wum);
}
...
void usart_receive_fifo_enable(uint32_t usart_periph)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000D0U)) |= ((uint32_t)((uint32_t)0x01U<<(8)));
}
...
uint8_t usart_receive_fifo_counter_number(uint32_t usart_periph)
{
    return (uint8_t)(((((*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000D0U))) & ((0xFFFFFFFFUL << ((12U))) & (0xFFFFFFFFUL >> (31U - (uint32_t)((14U)))))) >> (12U)));
}
# 1100 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
FlagStatus usart_flag_get(uint32_t usart_periph, usart_flag_enum flag)
{
    if(RESET != (((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x0000001FU)))))){
        return SET;
    }else{
        return RESET;
    }
}
# 1130 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_flag_clear(uint32_t usart_periph, usart_flag_enum flag)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000020U)) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(flag) & 0x0000001FU))));
}
# 1157 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_interrupt_enable(uint32_t usart_periph, usart_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x0000001FU))));
}
# 1184 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_interrupt_disable(uint32_t usart_periph, usart_interrupt_enum interrupt)
{
    ((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(interrupt) & 0x0000FFFFU) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(interrupt) & 0x0000001FU))));
}
# 1201 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_command_enable(uint32_t usart_periph, uint32_t cmdtype)
{
    (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000018U)) |= (cmdtype);
}
# 1230 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
FlagStatus usart_interrupt_flag_get(uint32_t usart_periph, usart_interrupt_flag_enum int_flag)
{
    uint32_t intenable = 0U, flagstatus = 0U;

    intenable = (((*(volatile uint32_t *)(uint32_t)((usart_periph) + (((uint32_t)(int_flag) & 0x0000FFFFU) >> 6)))) & ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(int_flag) & 0x0000001FU)))));

    flagstatus = (((*(volatile uint32_t *)(uint32_t)((usart_periph) + ((uint32_t)(int_flag) >> 22)))) & ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(int_flag) & 0x001F0000U) >> 16)))));
...
# 1267 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_usart.c"
void usart_interrupt_flag_clear(uint32_t usart_periph, usart_interrupt_flag_enum flag)
{
    if(USART_INT_FLAG_RFF == flag){
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x000000D0U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(15))));
    }else{
        (*(volatile uint32_t *)(uint32_t)((usart_periph) + 0x00000020U)) |= ((uint32_t)((uint32_t)0x01U<<((((uint32_t)(flag) & 0x001F0000U) >> 16))));
    }
}
