# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c" 2
# 37 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c"
...
# 38 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c" 2
...
void fwdgt_write_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000000U)) = ((uint16_t)0x00005555U);
}
...
void fwdgt_write_disable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000000U)) = ((uint16_t)0x00000000U);
}
...
void fwdgt_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000000U)) = ((uint16_t)0x0000CCCCU);
}
# 86 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c"
ErrStatus fwdgt_prescaler_value_config(uint16_t prescaler_value)
{
    uint32_t timeout = ((uint32_t)0x000FFFFFU);
    ...
    do{
        flag_status = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x0000000CU)) & ((uint32_t)((uint32_t)0x01U<<(0)));
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000004U)) = (uint32_t)prescaler_value;
...
ErrStatus fwdgt_reload_value_config(uint16_t reload_value)
{
    ...
    do{
        flag_status = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x0000000CU)) & ((uint32_t)((uint32_t)0x01U<<(1)));
    }while((--timeout > 0U) && ((uint32_t)RESET != flag_status));
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000008U)) = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(reload_value) << 0));
...
ErrStatus fwdgt_window_value_config(uint16_t window_value)
{
    uint32_t time_index = ((uint32_t)0x000FFFFFU);
    uint32_t flag_status = RESET;
    ...
    do{
        flag_status = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x0000000CU)) & ((uint32_t)((uint32_t)0x01U<<(2)));
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000010U)) = (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(window_value) << 0U));
...
void fwdgt_counter_reload(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000000U)) = ((uint16_t)0x0000AAAAU);
}
# 191 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c"
ErrStatus fwdgt_config(uint16_t reload_value, uint8_t prescaler_div)
{
    uint32_t timeout = ((uint32_t)0x000FFFFFU);
    uint32_t flag_status = RESET;
    ...
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x00000004U)) = (uint32_t)prescaler_div;

    timeout = ((uint32_t)0x000FFFFFU);
...
# 239 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_fwdgt.c"
FlagStatus fwdgt_flag_get(uint16_t flag)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x00003000U)) + 0x0000000CU)) & flag)){
        return SET;
    }
    return RESET;
}
