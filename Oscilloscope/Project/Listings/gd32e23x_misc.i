# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c" 2
                     ...
                     uint8_t nvic_irq_priority)
{
    ...
    __NVIC_SetPriority((IRQn_Type)nvic_irq, (uint32_t)nvic_irq_priority);
    __NVIC_EnableIRQ((IRQn_Type)nvic_irq);
}
...
void nvic_irq_disable(uint8_t nvic_irq)
{
    ...
    __NVIC_DisableIRQ((IRQn_Type)nvic_irq);
}
# 71 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void nvic_system_reset(void)
{
    __NVIC_SystemReset();
}
# 85 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = nvic_vict_tab | (offset & ((uint32_t)0x1FFFFF80U));
    __builtin_arm_dsb(0xF);
}
# 102 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)lowpower_mode;
}
# 118 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (~(uint32_t)lowpower_mode);
}
# 132 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
    if(((uint32_t)0x00000004U) == systick_clksource ){

        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL |= ((uint32_t)0x00000004U);
    }else{

        ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL &= ((uint32_t)0xFFFFFFFBU);
    }
}
