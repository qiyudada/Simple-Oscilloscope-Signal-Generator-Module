# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c" 2
...
void cmp_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) = ((uint32_t)0x00000000U);
}
# 72 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c"
void cmp_mode_init(operating_mode_enum operating_mode, inverting_input_enum inverting_input, cmp_hysteresis_enum output_hysteresis)
{
    uint32_t CMPx_CS = 0;

    CMPx_CS = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U));
    CMPx_CS &= ~(uint32_t)(((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) | ((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) | ((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) );
    CMPx_CS |= (uint32_t)((((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(operating_mode) << 2)) | (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(inverting_input) << 4)) | (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(output_hysteresis) << 12)));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) = CMPx_CS;
}
# 97 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_cmp.c"
void cmp_output_init(cmp_output_enum output_selection, uint32_t output_polarity)
{
    uint32_t CMPx_CS = 0;

    CMPx_CS = (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U));
    CMPx_CS &= ~(uint32_t)((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10))));
    CMPx_CS |= (uint32_t)(((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(output_selection) << 8));

    if(((uint32_t)0x00000001) == output_polarity){
        CMPx_CS |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
    }else{
        CMPx_CS &= ~(uint32_t)((uint32_t)((uint32_t)0x01U<<(11)));
    }
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) = CMPx_CS;
...
void cmp_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void cmp_switch_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(1)));
}
...
uint32_t cmp_output_level_get(void)
{
    if((*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(14)))){
...
void cmp_lock_enable(void)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(15)));
}
