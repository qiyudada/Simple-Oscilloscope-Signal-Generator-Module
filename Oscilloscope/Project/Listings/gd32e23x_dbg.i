# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 374 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c" 2
# 35 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
...
# 36 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c" 2
# 45 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
void dbg_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x04U)) = 0x00000000U;
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x08U)) = 0x00000000U;
}
...
uint32_t dbg_id_get(void)
{
    return (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x00U));
}
# 72 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
void dbg_low_power_enable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x04U)) |= dbg_low_power;
}
# 87 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
void dbg_low_power_disable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x04U)) &= ~dbg_low_power;
}
# 111 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
void dbg_periph_enable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
# 135 "../Firmware/GD32E23x_standard_peripheral/Source/gd32e23x_dbg.c"
void dbg_periph_disable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
